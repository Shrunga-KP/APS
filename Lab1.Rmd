...
```{r}
#box plot between price and heating
p = ggplot(data = hData) +
...
model2 = lm(data = hData, price ~ heating)
summary(model2)
```
...
summary(model1)
```
#RSS = variance not explained by linear model
#TSS = all possible variance
#TSS - RSS = variance actually explained by model
# R^2 =(TSS- RSS)/TSS =propotion of the total variance explained by model
